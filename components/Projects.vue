...
<template>
  <div
    class="flex-auto border items-center justify-center border-white/10 rounded-md p-8 w-3/4 lg:w-3/5 space-y-4 h-[480px]"
  >
    <div class="flex flex-row space-y-2 justify-between m-2">
      ...
      <p
        class="text-[11px] w-96 font-thin font-mono text-white/60 text-center p-2 bg-yellow-500/10 border border-white/20 rounded-md"
      >
        <span class="pi pi-exclamation-triangle" /> WARNING: Example projects
        will replace the current project, causing unsaved changes to be lost.
      </p>
    </div>
    ...
    <div>
      <ScrollPanel
        class="bg-black/30 rounded-lg p-6 border border-white/20"
